...
- [study/](./study/) — study projects and experiments
  ...
  - [xroads/](./study/xroads/) - multithreading crossroad simulation with lock-free SCSP FIFO
- [tools/](./tools/) — various utilities and tools
  - [RangeSearch/](./tools/RangeSearch/) - N-dimensional range search using k-d tree, range tree, and Boost R* tree 
